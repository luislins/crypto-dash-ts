...
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart, FiDollarSign } from 'react-icons/fi';
...
const gridEmployeeCountry = (props:dummyProps) => (
...
const customerGridImage = (props:dummyProps) => (
...
const customerGridStatus = (props:dummyProps) => (
...
export const coinsData = [
  {
    icon_image: 'https://assets.coingecko.com/coins/images/1/small/bitcoin.png?1547033579',
    low24h: '123289',
    high_24h: '128088',
    percentage24h: '3.57721',
    current_price: '127719',
    name:"Bitcoin",
    symbol:"btc"
  },
  {
